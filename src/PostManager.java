...
public class PostManager {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Unique Hashtags: " + String.join(", ", uniqueHashtags));
        System.out.println("Trending Posts: " + String.join(", ", trendingPosts));
        System.out.println("Unique Authors: " + String.join(", ", uniqueAuthors));
    }
}
